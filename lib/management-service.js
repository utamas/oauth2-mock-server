...
const beforeResponse = Symbol('beforeResponse');
const beforeResponseBinded = Symbol('beforeResponseBinded');
...
class ManagementService {
  constructor(authService) {
    ...
    this[beforeResponseBinded] = this[beforeResponse].bind(this);
  }
  ...
  [setSubHandler](req, res) {
    ...
    this[service].on('beforeResponse', this[beforeResponseBinded]);
  ...
  [deleteSubHandler](req, res) {
    ...
    this[service].removeListener('beforeResponse', this[beforeResponseBinded]);
  ...
  // eslint-disable-next-line no-unused-vars
  [beforeResponse](tokenEndpointResponse, req) {
    // eslint-disable-next-line no-param-reassign
    tokenEndpointResponse.body.emails = [{
      value: this[email],
      verified: true,
    }];
  }
